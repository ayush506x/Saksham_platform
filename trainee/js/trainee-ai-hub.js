...
- High-integrity SIL-4 architecture prevents Signal Passing At Danger (SPAD) and head-on/rear-end collisions.`
  ...
  // Offline fallback: mock trainer pool (used when backend is unreachable)
  const MOCK_TRAINERS = [
    {
      trainer_id: "TR-IMD-001", rank: 1,
      name: "Dr. Rajesh Mohan", designation: "Deputy Director General",
      department: "India Meteorological Department", station: "New Delhi",
      years_of_service: 22, avg_feedback_score: 4.9, pass_rate_percent: 94,
      email: "r.mohan@imd.gov.in", match_score: 96,
      subjects_taught: "Tropical Cyclone Warning, Coastal Alert Protocols, Severe Weather Nowcasting",
      why_match: "22 years specialising in cyclone track prediction and coastal alert dissemination with IMD's RSMC.",
      matched_skills: [
        { skill: "Cyclone Warning", proficiency: "Expert" },
        { skill: "Doppler Radar", proficiency: "Advanced" },
        { skill: "Nowcasting", proficiency: "Expert" }
      ],
      breakdown: { skill_match_K: 40, experience_match_E: 24, rating_R: 15 },
      tags: ["cyclone", "warning", "coastal", "alert", "severe", "nowcast", "radar", "doppler"]
    },
    {
      trainer_id: "TR-IMD-002", rank: 2,
      name: "Dr. Sunita Patel", designation: "Senior Scientist",
      department: "National Centre for Medium Range Weather Forecasting", station: "Noida",
      years_of_service: 17, avg_feedback_score: 4.8, pass_rate_percent: 91,
      email: "s.patel@ncmrwf.gov.in", match_score: 89,
      subjects_taught: "Numerical Weather Prediction, WRF Modelling, Data Assimilation",
      why_match: "Expert in WRF model configuration and 3D-Var / 4D-Var data assimilation workflows.",
      matched_skills: [
        { skill: "NWP / WRF", proficiency: "Expert" },
        { skill: "Data Assimilation", proficiency: "Expert" },
        { skill: "Python", proficiency: "Advanced" }
      ],
      breakdown: { skill_match_K: 38, experience_match_E: 22, rating_R: 14 },
      tags: ["nwp", "wrf", "numerical", "prediction", "data", "assimilation", "gfs", "ecmwf", "python", "model"]
    },
    {
      trainer_id: "TR-SAC-003", rank: 3,
      name: "Cmdr. Anil Verma (Retd.)", designation: "Senior Training Officer",
      department: "Space Applications Centre — ISRO", station: "Ahmedabad",
      years_of_service: 19, avg_feedback_score: 4.7, pass_rate_percent: 89,
      email: "a.verma@sac.isro.gov.in", match_score: 84,
      subjects_taught: "INSAT-3D/3DR Remote Sensing, Satellite Meteorology, GIS Applications",
      why_match: "19-year career in satellite data processing and INSAT-3D product training for forecasters.",
      matched_skills: [
        { skill: "Satellite Remote Sensing", proficiency: "Expert" },
        { skill: "GIS", proficiency: "Advanced" },
        { skill: "INSAT-3D", proficiency: "Expert" }
      ],
      breakdown: { skill_match_K: 36, experience_match_E: 23, rating_R: 13 },
      tags: ["satellite", "remote", "sensing", "insat", "gis", "isro", "imagery", "spectral"]
    },
    {
      trainer_id: "TR-RDSO-004", rank: 1,
      name: "Shri. K. Srinivasan", designation: "Divisional Engineer (Signalling)",
      department: "Research Designs & Standards Organisation", station: "Lucknow",
      years_of_service: 15, avg_feedback_score: 4.8, pass_rate_percent: 92,
      email: "k.srinivasan@rdso.indianrailways.gov.in", match_score: 93,
      subjects_taught: "Kavach ATP System, Automatic Train Protection, Railway Signalling Safety",
      why_match: "Core team member of the Kavach ATP rollout; certified SIL-4 safety systems trainer.",
      matched_skills: [
        { skill: "Kavach / ATP", proficiency: "Expert" },
        { skill: "Signalling Safety", proficiency: "Expert" },
        { skill: "Risk Assessment", proficiency: "Advanced" }
      ],
      breakdown: { skill_match_K: 39, experience_match_E: 20, rating_R: 14 },
      tags: ["rail", "kavach", "atp", "train", "protection", "signalling", "spad", "safety", "rdso"]
    },
    {
      trainer_id: "TR-IMD-005", rank: 2,
      name: "Dr. Meera Krishnamurthy", designation: "Scientist-E",
      department: "India Meteorological Department", station: "Chennai",
      years_of_service: 14, avg_feedback_score: 4.6, pass_rate_percent: 88,
      email: "m.krishnamurthy@imd.gov.in", match_score: 82,
      subjects_taught: "Agrometeorology, Crop Weather Calendar, Gramin Krishi Mausam Seva",
      why_match: "14 years in agrometeorological advisory services, expert in crop stress indices and hydromet risk.",
      matched_skills: [
        { skill: "Agrometeorology", proficiency: "Expert" },
        { skill: "Hydromet Risk", proficiency: "Advanced" },
        { skill: "Crop Advisory", proficiency: "Expert" }
      ],
      breakdown: { skill_match_K: 35, experience_match_E: 18, rating_R: 13 },
      tags: ["agromet", "agrometeorology", "crop", "weather", "calendar", "hydromet", "gramin", "krishi"]
    },
    {
      trainer_id: "TR-IMD-006", rank: 1,
      name: "Dr. Prakash Nair", designation: "Scientist-F",
      department: "India Meteorological Department", station: "Mumbai",
      years_of_service: 20, avg_feedback_score: 4.9, pass_rate_percent: 95,
      email: "p.nair@imd.gov.in", match_score: 97,
      subjects_taught: "Doppler Radar Operations, Dual-Pol Interpretation, Severe Thunderstorm Nowcasting",
      why_match: "20 years of operational Doppler radar experience; trained 400+ forecasters across IMD.",
      matched_skills: [
        { skill: "Doppler Radar", proficiency: "Expert" },
        { skill: "Dual-Pol", proficiency: "Expert" },
        { skill: "Nowcasting", proficiency: "Expert" }
      ],
      breakdown: { skill_match_K: 40, experience_match_E: 25, rating_R: 15 },
      tags: ["radar", "doppler", "dual-pol", "reflectivity", "nowcast", "velocity", "storm", "convective"]
    }
  ];
  ...
  const Hub = {
    ...
    async findTrainers(presetSkills) {
      ...
      try {
        ...
        console.info('Backend offline, using local faculty data.');
        const fallbackTrainers = this.generateLocalFallbackTrainers(skills, minExp);
        currentTrainersCache = fallbackTrainers;
        this.renderTrainers(fallbackTrainers);
      } finally {
        if (btn) {
          btn.disabled = false;
    ...
    generateLocalFallbackTrainers(skills, minExp) {
      // Score each mock trainer against the requested skills
      const scored = MOCK_TRAINERS
        .filter(t => t.years_of_service >= (minExp || 0))
        .map(t => {
          const keywordsMatched = (skills || []).filter(s =>
            t.tags.some(tag => tag.includes(s.toLowerCase()) || s.toLowerCase().includes(tag))
          ).length;
          return { ...t, _localScore: keywordsMatched };
        })
        .sort((a, b) => b._localScore - a._localScore || b.match_score - a.match_score)
        .slice(0, 3)
        .map((t, i) => ({ ...t, rank: i + 1 }));
      return scored.length > 0 ? scored : MOCK_TRAINERS.slice(0, 3).map((t, i) => ({ ...t, rank: i + 1 }));
    },
